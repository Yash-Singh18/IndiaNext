...
def build_rag_prompt(context: str, sources: list[dict]) -> str:
    ...
    return (
        ...
        "RULES:\n"
        "- Lead with a direct answer grounded in the strongest relevant details from the context.\n"
        "- Do not say that the answer is missing from the context or that there is no mention of a topic in the provided context.\n"
        "- If the evidence is partial, give the best supported answer from the available material without inventing source citations.\n"
